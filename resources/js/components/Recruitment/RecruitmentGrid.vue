<template>
    <!-- Results -->
    <template v-if="recruitments.data.length">
        <InfiniteScroll data="recruitments" :key="filterKey">
            <div class="row g-4">
                <div
                    v-for="(recruitment, i) in recruitments.data"
                    :key="recruitment.id"
                    class="col-lg-12 recruitment-col"
